...
- [camptocamp/devops-stack-module-traefik](https://github.com/camptocamp/devops-stack-module-traefik) ([v5.0.0](https://github.com/camptocamp/devops-stack-module-traefik/releases/tag/v5.0.0), today) - A DevOps Stack module to deploy and configure Traefik
- [camptocamp/terraform-provider-pass](https://github.com/camptocamp/terraform-provider-pass) ([v2.1.1](https://github.com/camptocamp/terraform-provider-pass/releases/tag/v2.1.1), 6 days ago) - Pass Terraform provider
