...
- [camptocamp/devops-stack](https://github.com/camptocamp/devops-stack) ([v1.3.0](https://github.com/camptocamp/devops-stack/releases/tag/v1.3.0), today) - 🌊 An all-in-one Kubernetes ☸ stack using Argo CD 🐙 and Terraform as base components
