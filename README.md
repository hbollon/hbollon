...
- [camptocamp/grafana-prometheus-alertmanager-datasource](https://github.com/camptocamp/grafana-prometheus-alertmanager-datasource) ([v1.1.0](https://github.com/camptocamp/grafana-prometheus-alertmanager-datasource/releases/tag/v1.1.0), 5 days ago) - Grafana Datasource for the Prometheus Alertmanager
...
- [fix(pushprox): allow empty oauth provider configuration](https://github.com/camptocamp/charts/pull/63) on [camptocamp/charts](https://github.com/camptocamp/charts) (2 days ago)
- [fix(pushprox): ingress compatibility issues with k8s &gt;= 1.22](https://github.com/camptocamp/charts/pull/62) on [camptocamp/charts](https://github.com/camptocamp/charts) (5 days ago)
