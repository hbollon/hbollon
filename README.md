...
- [geoadmin/service-control](https://github.com/geoadmin/service-control) - OGD Access Controller (2 days ago)
...
- [hbollon/go-edlib](https://github.com/hbollon/go-edlib) ([v1.7.0](https://github.com/hbollon/go-edlib/releases/tag/v1.7.0), 3 days ago) - 📚 String comparison and edit distance algorithms library, featuring : Levenshtein, LCS, Hamming, Damerau levenshtein (OSA and Adjacent transpositions algorithms), Jaro-Winkler, Cosine, etc...
- [geoadmin/service-control](https://github.com/geoadmin/service-control) ([v0.10.0](https://github.com/geoadmin/service-control/releases/tag/v0.10.0), 1 month ago) - OGD Access Controller
