...
- [geoadmin/service-control](https://github.com/geoadmin/service-control) ([v0.21.0](https://github.com/geoadmin/service-control/releases/tag/v0.21.0), 4 days ago) - OGD Access Controller
...
- [feat(agents): add dynamic custom subagent registration](https://github.com/alvinunreal/oh-my-opencode-slim/pull/359) on [alvinunreal/oh-my-opencode-slim](https://github.com/alvinunreal/oh-my-opencode-slim) (5 days ago)
