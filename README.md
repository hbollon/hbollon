...
- [hbollon/k8s-voting-app-aws](https://github.com/hbollon/k8s-voting-app-aws) - :wheel_of_dharma: Example of a Kubernetes voting app written in Golang with Terraform definitions to deploy to AWS (1 day ago)
