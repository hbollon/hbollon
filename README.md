...
- [camptocamp/devops-stack](https://github.com/camptocamp/devops-stack) ([v1.5.2](https://github.com/camptocamp/devops-stack/releases/tag/v1.5.2), today) - 🌊 An all-in-one Kubernetes ☸ stack using Argo CD 🐙 and Terraform as base components
