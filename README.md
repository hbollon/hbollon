...
- [camptocamp/devops-stack](https://github.com/camptocamp/devops-stack) ([v1.1.0](https://github.com/camptocamp/devops-stack/releases/tag/v1.1.0), today) - 🌊 An all-in-one Kubernetes ☸ stack using Argo CD 🐙 and Terraform as base components
